...
namespace MiniPlantaJugos.Controllers
{
    public class IncidentesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MaquinaId,UsuarioId,Descripcion,Severidad")] Incidente incidente)
        {
            if (ModelState.IsValid)
            {
                ...
                TempData["Success"] = "¡Incidente reportado correctamente!";
